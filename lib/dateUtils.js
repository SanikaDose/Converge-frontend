...
export const parseISO = (isoDate) => new Date(isoDate + "T00:00:00Z");
...
export function addWorkingDays(isoDate, count) {
...
export function weekNumber(dateISO, projectStartDate) {

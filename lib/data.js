...
/* ---------------------------------------------------------------------
   ...
   start date (in *working* days — see dateUtils.js). duration = task
...
export const STATUS_OPTIONS = ["Not Started", "In Progress", "Pending Approval", "Delayed", "Completed"];
...
export const PRIORITY_COLOR = { Low: "slate", Medium: "amber", High: "red", Critical: "red" };
...
export const SCHEDULING_FIELDS = ["dayOffset", "plannedStart", "plannedFinish", "duration"];

 ...
 * per-project KanbanView, but flattened across every project instead of
 * one. Cards carry a project name (not just phase) since the same phase
 * name recurs across projects and would otherwise be ambiguous; drag/drop
 * routes the status change back to whichever project the card belongs to
